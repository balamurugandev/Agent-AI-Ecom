...
1. Go to your Supabase dashboard: https://supabase.com/dashboard/project/lmuqidjftjonxqraclhd
2. Click **SQL Editor** in the left sidebar
3. Click **New Query**
4. Copy the ENTIRE contents of `supabase/schema.sql` below
5. Paste into the SQL Editor
6. Click **Run** (or press Cmd/Ctrl + Enter)

---

## Copy this SQL (from schema.sql):
...
After running the schema, come back here and run:

```bash
npx tsx scripts/seed-database.ts
```

This will populate products and variants from your JSON files.
